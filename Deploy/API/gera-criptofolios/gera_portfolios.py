...
def gera_portfolios(lista_ativos, df_retornos, df_fin, matriz_covar, lista_pesos, n_componentes, n_iter):
...
df_portfolios = gera_portfolios(lista_ativos=ativos, df_retornos = df_retornos, df_fin = df_fin, matriz_covar=matriz_covar, lista_pesos=lista_pesos, n_componentes=n_componentes, n_iter=n_iter)
...
sharpe_max.name = "Moderado"#'sharpe_max'
...
df_portfolios_escolhidos['indicador'] = ["risco_min", "sharpe_max", "sortino_max", "roys_safety_max", "retorno_max"]

df_portfolios_escolhidos.to_csv("dataframes/df_portfolios_escolhidos.csv", index = True)

print(df_portfolios_escolhidos)
